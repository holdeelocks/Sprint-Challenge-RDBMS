...
1. Explain the difference between `RDBMS` and `SQL`.
   RDBMS is the system (a relational database system) and SQL is the language used to interact with the system.

1. Why do tables need a `primary key`?
   The primary key is how you can uniquely identify the different elements of a column, otherwise they might be indistinguishable from one another.
